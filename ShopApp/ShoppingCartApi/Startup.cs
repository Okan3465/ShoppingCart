...
namespace ShoppingCartApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<Context>(options => options.UseSqlite(Configuration.GetConnectionString("ShoppingCartDb")));//
            ...
            //services.AddScoped<IGenericDal, GenericRepository>();
        }
